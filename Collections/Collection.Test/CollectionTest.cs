...
namespace Collection.Test
{
    public class CollectionTest
    {
        ...
        [TestCase("Peter, Ivan, Asen", 0, "Peter")]
        [TestCase("Peter, Ivan, Asen", 1, "Ivan")]
        [TestCase("Peter, Ivan, Asen", 2, "Asen")]
        public void Test_Collection_GetByValidIn(string data, int index, string result)
        {
        ...
        {
            //Arange
            var nums = new Collection<int>(12, 13, 14, 15);
            ...
            Assert.That(nums[1], Is.EqualTo(22));
            Assert.That(nums[2], Is.EqualTo(123));
